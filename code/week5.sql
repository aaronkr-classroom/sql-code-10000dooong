...
-- 학생 테이블생성
CREATE TABLE 학생
	( 학번 CHAR(4) NOT NULL, -- 글자 4개, NULL 값은 사용 금지
	이름 VARCHAR(20) NOT NULL, 
	주소 VARCHAR(50) NULL DEFAULT '미정', -- NULL 가능
	학년 INT NOT NULL,
	나이 INT NULL,
	성별 CHAR(1) NOT NULL,
	휴대폰번호 CHAR(14) NULL,
...
SELECT 나이, COUNT(*) AS 나이별 FROM 학생
